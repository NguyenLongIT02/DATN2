...
public enum ErrorCode {
    ...
    // --- SCRUMBOARD (4000-4999)
    SCRUMBOARD_CHECKLIST_INCOMPLETE(4000, MessageKeys.CARD_CHECKLIST_INCOMPLETE, HttpStatus.BAD_REQUEST),
    SCRUMBOARD_LIST_NAME_EXISTS(4001, MessageKeys.LIST_NAME_EXISTS, HttpStatus.BAD_REQUEST),
    SCRUMBOARD_WORKFLOW_INVALID(4002, MessageKeys.CARD_WORKFLOW_INVALID, HttpStatus.BAD_REQUEST),
    SCRUMBOARD_DEPENDENCY_INCOMPLETE(4003, MessageKeys.CARD_DEPENDENCY_INCOMPLETE, HttpStatus.BAD_REQUEST),
    SCRUMBOARD_DOD_MEMBER_REQUIRED(4004, MessageKeys.CARD_MEMBER_REQUIRED, HttpStatus.BAD_REQUEST),
    SCRUMBOARD_DOD_NOT_IN_PROGRESS(4005, MessageKeys.CARD_DOD_NOT_IN_PROGRESS, HttpStatus.BAD_REQUEST),
    SCRUMBOARD_WORKFLOW_BACKWARD_NOT_ALLOWED(4006, MessageKeys.CARD_WORKFLOW_BACKWARD_NOT_ALLOWED, HttpStatus.BAD_REQUEST);
